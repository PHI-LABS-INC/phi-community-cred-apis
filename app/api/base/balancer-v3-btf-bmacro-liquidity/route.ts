...
const USDC_AAVE_V3_POOL = "0x3f170631ed9821Ca51A59D996aB095162438DC10";
const ETHERSCAN_API = "https://api.etherscan.io/v2/api";
const API_KEY = process.env.BASE_SCAN_API_KEY_02;

type Tx = { to?: string };

async function hasAddedBtfBmacroV3Liquidity(address: Address): Promise<boolean> {
...
export async function GET(req: NextRequest) {
  try {
    ...
    const mint_eligibility = await hasAddedBtfBmacroV3Liquidity(
      address as Address
    );
